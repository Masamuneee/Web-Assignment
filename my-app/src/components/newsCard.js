...
function NewsCard({ category, title, description, date, image, linkToNews }) {
  return (
    <Link href={linkToNews}>
...
function NewsCardHero({ category, title, description, date, image, linkToNews }) {
  return (
    <Link href={linkToNews}>
